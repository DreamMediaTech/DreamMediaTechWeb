								...
								<table class="datatable-1 table table-message">
								   <thead>
									...
									<tr class="heading">
											...
											<td class="cell-title" style="text-align:center;vertical-align:middle;">角色类型</td>
											<td class="cell-title" style="text-align:center;vertical-align:middle;">角色描述</td>
									...
									<c:forEach items="${list}" var="list">
										...
										<tr class="task " >
											...
											<td class="cell-title" style="text-align:center;vertical-align:middle;">${list.getrName()}</td>
											<td class="cell-title" style="text-align:center;vertical-align:middle;">${list.getrDescribe()}</td>
											
											<td class="cell-title" style="text-align:center;vertical-align:middle;"><input type="button" value="修改权限" class="btn btn-info" onclick="javascript:window.location.href='${pageContext.request.contextPath}/function_roleController/queryonerole.action?rId=${list.getrId()}'"></td>
