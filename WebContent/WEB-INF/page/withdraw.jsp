								...
								<div class="pull-left">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="${pageContext.request.contextPath}/otherController/getnowithdrawal.action">未处理 <b class="label green pull-right">
                                    11</b></a></li>
							...
							<div class="module-body table">								
								...
								<thead>
										...
										<tr class="task"  >
											...
											<td class="cell-status hidden-phone hidden-tablet" style="text-align:center;vertical-align:middle;"><c:if test="${list.getBwState()=='未处理'}"><b class="due"></c:if>${list.getBwState()}</b></td>
