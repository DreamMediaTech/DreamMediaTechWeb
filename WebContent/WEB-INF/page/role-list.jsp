                                ...
                                <div class="module-body table">
                                    <table  class="datatable-1 table table-message">
                                        <thead>
                                            ...
                                            <td> <a href="${pageContext.request.contextPath}/function_roleController/deleterole.action?rId=${role.getrId()}" class="btn btn-primary">删除</a>
                                        <a href="${pageContext.request.contextPath}/function_roleController/queryonerole.action?rId=${role.getrId()}" class="btn btn-primary">修改</a></td>
                                            </tr>
                                             </c:forEach>
