                                ...
                                <div class="module-body table">
                                    <table  class="datatable-1 table table-message" >
										...
										<tr class="task " >
											...
											<td class="cell-status hidden-phone hidden-tablet" style="text-align:center;vertical-align:middle;"><c:if test="${list.getVprState()=='未处理'}"><b class="due"></c:if>${list.getVprState()}</b></td>
											...
											<c:if test="${list.getVprState()=='未处理'}">
											<input type ="button" onclick="javascript:window.location.href='${pageContext.request.contextPath}/videoController/updatevideopay.action?vprId=${list.getVprId()}'" value="通过" class="btn btn-info">
											<input type ="button" onclick="javascript:window.location.href='${pageContext.request.contextPath}/videoController/updatevideopay.action?vprId=${list.getVprId()}'" value="拒绝" class="btn btn-info">
											</c:if>
											</td>
										</tr>
