                        ...
                        <div class="content">
                            ...
                            <div class="module-body">
                                ...
                                <section class="docs">
                                  ...
                                  <hr/>
                                 <h2 class="text-center" align="center"><input onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/deletearticle.action?aId=${article.getaId()}'" class="btn btn-info" value="删除" type="button"></h2>
                            </div>
                            </div>
                            </div>
                            <!--/.module-->
