                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <div class="module message">
                              ...
                              <form action="${pageContext.request.contextPath}/function_roleController/updateRole.action?rId=${role.getrId()}" method="post">
                                    <table align="center" >  
                                    <tr>
                                    <td width="10%" >
                                       	当前角色：
                                    ...
                                    <td >                                  
                                    <input type="text" name="rName" value="${role.getrName()}">                               
                                    </td>
                                    </tr>
                                      <tr>
                                    <td width="10%">
                                ...
                                <input type="text" name="rDescribe" value="${role.getrDescribe()}">
                                  <input type="submit" class="btn btn-info" value="修改">
                                      ...
                                      <form action="${pageContext.request.contextPath}/function_roleController/deleteFunctionbyrole.action" method="post" >
                                    <table>
                                    <tr>
                                    <td width="10%">
                                     	现有权限：
                                    ...
                                    <c:forEach items="${list}"  var="list">
                                     ...
                                     <i class="icon-star">
                                <input    type="checkbox" id="fids" name="fids" value="${list.getfId()}">
                                   &nbsp;${list.getfName()}&nbsp;</i><br>
                                     
                                      </c:forEach>
                                      <div class="a">
                                      <input type="submit"   class="btn btn-info" name="delete" id="delete" value="删除" >
...
<div class="modal fade" id="myModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="${pageContext.request.contextPath}/function_roleController/insertFunction.action?rid=${role.getrId()}" method="post">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<c:forEach items="${unfunction}" var="unfunction">
				 <i class="icon-star"> <input    type="checkbox" id="fids" name="fids" value="${unfunction.getfId()}">
				 ${unfunction.getfName()}</i><br/>
				</c:forEach>
