                                ...
                                <div class="module-body table">
                                    <table  class="datatable-1 table table-message">
                                        <thead>
                                            ...
                                            <td>${role.getrName()}</td>
                                            <td>${role.getrDescribe()}</td>
                                           
                                            
                                            <td> 
                                        <a href="${pageContext.request.contextPath}/function_roleController/queryonerole.action?rId=${role.getrId()}" class="btn btn-primary">修改</a>
                                        <a href="${pageContext.request.contextPath}/function_roleController/deleterole.action?rId=${role.getrId()}" class="btn btn-primary">删除</a></td>
                                            </tr>
                                             </c:forEach>
...
<div class="modal fade" id="myModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="${pageContext.request.contextPath}/function_roleController/insertRole.action" method="post">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<table >
			<tr><td>
			<input type="text" name="rName" placeholder="请输入角色名称">
			</td></tr>
			<tr><td>
			<textarea style="resize: none;" class="form-control" rows="5" id="rDescribe" name="rDescribe" placeholder="请输入角色描述"></textarea>
			</td></tr>
			<tr>
			<td class="cell-icon hidden-phone hidden-tablet ">
			<h2>添加权限</h2>
			...
			<tr>
			<td>
			 <i class="icon-star"> <input    type="checkbox" id="fids" name="fids" value="${function.getfId()}">
			 		${function.getfName()}</i><br/>
			</td>
			</tr>
			</c:forEach>
			</table>
