                        ...
                        <div class="content">
                            ...
                            <div class="module message">
                               ...
                               <div class="pull-left">
									选项 : &nbsp;
									<div class="btn-group">
										<button onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/getarticlerequest.action'" class="btn">所有</button>
										<button class="btn dropdown-toggle" data-toggle="dropdown">
											<span class="caret"></span>
										</button>
											<ul class="dropdown-menu">
											<li><a href="${pageContext.request.contextPath}/articleController/queryarticleoff.action">未审核<b class="label green pull-right">
                                    11</b></a></li>
											<li><a href="${pageContext.request.contextPath}/articleController/queryarticleno.action">审核不通过</a></li>
											<li><a href="${pageContext.request.contextPath}/articleController/queryarticleon.action">审核通过</a></li>
										</ul>
									</div>
								</div>  
                                      </div>
                                    ...
                                    <table  class="datatable-1 table table-message">
                                        ...
                                        经手人姓名
                                          ...
                                          处理时间
                                            ...
                                            <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'">${list.getaTitle()}</td>
                                            <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'">${list.getUser().getuName()}</td>
                                            <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'">${list.getaTime()}</td>
                                         <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'"><c:if test="${list.getaState()=='待审核'}"><b class="due"></c:if>${list.getaState()}</b></td>
                                         <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'">${list.getAuName()}</td>
                                         <td style="text-align:center;vertical-align:middle;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/queryarticlerequest.action?aId=${list.getaId()}'">${list.getaSendtime()}</td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
