                    ...
                    <div class="span9">
                        ...
                        <div class="module">
							...
							<div class="module-body">
								<form class="form-horizontal row-fluid" action="${pageContext.request.contextPath}/agencyController/updateagents.action?agId=${agents.getAgId()}" method="post">
								<div class="control-group">
											<label class="control-label" for="basicinput">代理商编号：</label>
											<div class="controls">
												<input type="text" style="text-align:center;" name="agId" value="${agents.getAgId()}" class="span8" disabled>
											</div>
										</div>
								
									<div class="control-group">
											<label class="control-label" for="basicinput">真实姓名：</label>
											<div class="controls">
												<input type="text" style="text-align:center;" name="uName"  value="${agents.getUser().getuName()}" class="span8" disabled>
											</div>
										</div>
								...
								<div class="control-group">
											...
											<div class="controls">
												<input type="text" style="text-align:center;" name="mId"  value="${agents.getMember().getmId()}" class="span8" disabled>
											</div>
										</div>
											...
											<div class="controls">
												<input type="text" style="text-align:center;" name="birthday"  value="${agents.getMember().getBirthday()}" class="span8" disabled>
											</div>
										</div>
											...
											<div class="controls">
												<input type="text" style="text-align:center;" name="uSex"    value="${agents.getUser().getuSex()}" class="span8" disabled>
											</div>
										</div>
										
											<div class="control-group">
											<label class="control-label" for="basicinput">代理区域：</label>
											<div class="controls">
												<input type="text" style="text-align:center;" name="area"    value="${agents.getArea()}" class="span8" >
											</div>
										</div>
										
												<div class="control-group">
											<label class="control-label" for="basicinput">一级返利：</label>
											<div class="controls">
												<div class="input-append">
													<input  type="number" name="firstRebate"  value="${agents.getFirstRebate()}" class="span8"><span class="add-on">%</span>
												</div>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append">
													<input  type="number"  name="secondRebate"  value="${agents.getSecondRebate()}" class="span8"><span class="add-on">%</span>
												</div>
											</div>
										</div>
