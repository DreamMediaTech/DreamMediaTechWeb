                        ...
                        <div class="content">
                            ...
                            <div class="module-body">
                                ...
                                <section class="docs">
                                    ...
                                    <label >发布人：${article.getUser().getuName()}&nbsp;&nbsp;发布日期：${article.getaTime()}</label>
                                    </div>
                                    <div>
                                    ${article.getaContent()}
                                    </div>
                                  ...
                                  <hr/>
                                  <c:if test="${article.getaState()=='待审核'}">
                                 <h2 class="text-center" align="center"><input onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/updateArticley.action?aId=${article.getaId()}'" class="btn btn-info" value="通过" type="button"></h2>
                            	<h2 class="text-center" align="center"><input onclick="javascript:window.location.href='${pageContext.request.contextPath}/articleController/updateArticlen.action?aId=${article.getaId()}'" class="btn btn-info" value="不通过" type="button"></h2>
                         </c:if>
                            </div>
                            </div>
                            </div>
