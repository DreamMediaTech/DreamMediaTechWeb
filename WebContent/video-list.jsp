                        ...
                        <div class="content">
                          <div class="module message">
                                <div class="module-head">
                                 ...
                                 <div class="pull-left">
                                  <a href="#" class="btn btn-primary">我的视频</a>
                              </div>
                                      </div>
                           <div class="module-body table">
                                    <table  class="datatable-1 table table-message">
                                        <thead>
                                            ...
                                            <tbody>                            
                                             <tr onclick="javascript:window.location.href='video-detail.html'" >                                                            
	<td><img class="media-object" src="images/img.jpg" alt="媒体对象"></td>
	<td>	<h4 class="media-heading">视频标题</h4>
		这是一些示例简介。这是一些示例简介。
		这是一些示例简介。这是一些示例简介。
		这是一些示例简介。这是一些示例简介。
		这是一些示例简介。这是一些示例简介。
		这是一些示例简介。这是一些示例简介。</td>
</tr>
  <tr>                                                            
	<td><img class="media-object" src="images/img.jpg" alt="媒体对象"></td>
	<td>	<h4 class="media-heading">视频标题</h4>
