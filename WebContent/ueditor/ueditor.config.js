...
(function () {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || getUEBasePath(); //"/DreamProject/ueditor/";
//	var URL = "http://loaclhost:8080/DreamProject/ueditor"
    /**
    ...
    window.UEDITOR_CONFIG = {
		...
		,whitList: {
			...
			u:      [],
			ul:     ['class', 'style'],
			video:  ['autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'width', 'class', 'style','_url'],
    		//新增 and img中的src
			source:['src','type'],
